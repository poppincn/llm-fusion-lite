/** LLM Fusion Lite core — public API. */
...
export { materializeConfig, defaultProvidersFor } from "./config.js";
export { fuse, availableAutoPanel } from "./fusion.js";
export type { FuseDeps } from "./fusion.js";
export { preflightCredentials, formatMissingCredentials, modelCredentialReady } from "./credentials.js";
...
export type { ModelStrength, PanelPick, ProviderUsage, ModelUsage, UsageTotals, UsageReport } from "./store.js";
